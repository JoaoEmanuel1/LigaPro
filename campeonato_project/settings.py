"""
Django settings for campeonato_project project.
...
SECRET_KEY = 'django-insecure-tweu2iz*(n3!%4_a&#suh2c+38gn3h*7e#^y(38ddkm*1p0kix'
DEBUG = True
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'campeonato_project.wsgi.application'
